...
def bart_summarize(input_text, num_beams=4, num_words=50):
    ...
    summary_ids = bart_model.generate(input_tokeniz+ed,
...
@app.route('/TextPrediction', methods=['GET'])
def TextPrediction():
    return render_template('TextPrediction.html')

@app.route('/TextPredictionMasked', methods=['GET'])
def TextPredictionMasked():
    return render_template('TextPredictionMasked.html')

@app.route('/BINOD', methods=['GET'])
def BINOD():
    return render_template('BINOD.html')
